...
$(function(){
    ...
    $.fn.editableform.buttons =
        '<button type="submit" class="btn-add-new btn btn-primary editable-submit btn-sm waves-effect waves-light"><i class="mdi mdi-check"></i></button>' +
